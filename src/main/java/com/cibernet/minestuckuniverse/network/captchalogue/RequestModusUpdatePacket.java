...
public class RequestModusUpdatePacket extends MSUPacket
{
	...
	public void execute(EntityPlayer player)
	{
		...
		if(player != null)
			MSUChannelHandler.sendToPlayer(MSUPacket.makePacket(Type.UPDATE_MODUS, CaptchaDeckHandler.writeToNBT(MinestuckPlayerData.getData(target).modus)), player);
	}
