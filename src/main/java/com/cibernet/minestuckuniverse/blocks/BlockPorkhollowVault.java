...
public class BlockPorkhollowVault extends BlockContainer
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyBool POWERED = PropertyBool.create("powered");
    protected BlockPorkhollowVault()
    {
        super(Material.IRON);
        setUnlocalizedName("porkhollowVault");
        setRegistryName("porkhollow_vault");
    ...
    {
        TileEntityPorkhollowVault te = (TileEntityPorkhollowVault) worldIn.getTileEntity(pos);
        ...
        {
            NBTTagCompound nbt = stack.getTagCompound();
            if(worldIn.getTileEntity(pos) instanceof TileEntityPorkhollowVault)
            {
                TileEntityPorkhollowVault vault = (TileEntityPorkhollowVault) worldIn.getTileEntity(pos);
    ...
    public void onVaultBroken(TileEntityPorkhollowVault vault)
    {
    ...
    {
        if(!(te instanceof TileEntityPorkhollowVault))
        {
        ...
        TileEntityPorkhollowVault vault = (TileEntityPorkhollowVault) te;
    ...
    public ItemStack getItem(TileEntityPorkhollowVault vault)
    {
        ItemStack stack = new ItemStack(MinestuckUniverseBlocks.porkhollowVault);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if(!worldIn.isRemote) {
            ...
            playerIn.openGui(MinestuckUniverse.instance, MSUUtils.PORKHOLLOW_VAULT_GUI, worldIn, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
    ...
    {
        return new TileEntityPorkhollowVault();
    }
