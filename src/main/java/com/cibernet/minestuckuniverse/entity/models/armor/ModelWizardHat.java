...
public class ModelWizardHat extends ModelBiped {
	...
	public ModelWizardHat() {
		...
		whRim.cubeList.add(new ModelBox(whRim, 0, 25, -2.5F, -1.0F, -6.0F, 5, 1, 2, 0.0F, false));
		whRim.cubeList.add(new ModelBox(whRim, 56, 25, -2.5F, -1.0F, 4.0711F, 5, 1, 2, 0.0F, false));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(6.7678F, 0.0F, 5.5815F);
		whRim.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, -0.7854F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 98, 25, -11.2071F, -1.0F, -5.1716F, 5, 1, 2, 0.0F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(4.0711F, 0.0F, 6.0711F);
		whRim.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, -1.5708F, 0.0F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 84, 25, -8.5355F, -1.0F, -1.9645F, 5, 1, 2, 0.0F, false));

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(8.1317F, 0.0F, -0.1464F);
		whRim.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0F, 0.7854F, 0.0F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 70, 25, -8.3787F, -1.0F, -1.5858F, 5, 1, 2, 0.0F, false));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-6.0104F, 0.0F, 1.9749F);
		whRim.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, -0.7854F, 0.0F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 42, 25, 0.3787F, -1.0F, -1.5858F, 5, 1, 2, 0.0F, false));

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(-6.0F, 0.0F, -3.0F);
		whRim.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, -1.5708F, 0.0F);
		cube_r5.cubeList.add(new ModelBox(cube_r5, 28, 25, 0.5355F, -1.0F, -1.9645F, 5, 1, 2, 0.0F, false));

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-4.6464F, 0.0F, -0.5398F);
		whRim.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, 0.7854F, 0.0F);
		cube_r6.cubeList.add(new ModelBox(cube_r6, 14, 25, 0.3787F, -1.0F, -2.3431F, 5, 1, 2, 0.0F, false));

		whLayer1 = new ModelRenderer(this);
		whLayer1.setRotationPoint(0.0F, 0.0F, 0.0F);
		wizardHat.addChild(whLayer1);
		whLayer1.cubeList.add(new ModelBox(whLayer1, 0, 22, -2.0F, -2.0F, -5.0F, 4, 2, 1, 0.0F, false));
		whLayer1.cubeList.add(new ModelBox(whLayer1, 40, 22, -2.0F, -2.0F, 3.6569F, 4, 2, 1, 0.0F, false));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(0.5858F, 0.0F, -0.7574F);
		whLayer1.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, -0.7854F, 0.0F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 70, 22, -2.0F, -2.0F, -4.0F, 4, 2, 1, 0.0F, false));

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(2.8284F, 0.0F, -3.0784F);
		whLayer1.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.0F, -1.5708F, 0.0F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 60, 22, 0.9069F, -2.0F, -2.0F, 4, 2, 1, 0.0F, false));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(-1.4905F, 0.0F, -6.6517F);
		whLayer1.addChild(cube_r9);
		setRotationAngle(cube_r9, 0.0F, 0.7854F, 0.0F);
		cube_r9.cubeList.add(new ModelBox(cube_r9, 50, 22, -5.5282F, -2.0F, 9.4645F, 4, 2, 1, 0.0F, false));
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 30, 22, -2.0F, -2.0F, 3.0F, 4, 2, 1, 0.0F, false));
		...
		cube_r11.cubeList.add(new ModelBox(cube_r11, 20, 22, -7.75F, -2.0F, -2.0F, 4, 2, 1, 0.0F, false));
		...
		cube_r12.cubeList.add(new ModelBox(cube_r12, 10, 22, -5.0F, -2.0F, -6.0F, 4, 2, 1, 0.0F, false));
		...
		whLayer2.cubeList.add(new ModelBox(whLayer2, 0, 19, -1.5F, -3.25F, -4.25F, 3, 2, 1, 0.25F, false));
		whLayer2.cubeList.add(new ModelBox(whLayer2, 32, 19, -1.5F, -3.25F, 2.6997F, 3, 1, 1, 0.25F, false));
		...
		cube_r13.cubeList.add(new ModelBox(cube_r13, 56, 19, 2.4393F, -3.25F, -0.3609F, 3, 2, 1, 0.25F, false));
		...
		cube_r14.cubeList.add(new ModelBox(cube_r14, 48, 19, -5.9749F, -3.25F, -1.7751F, 3, 2, 1, 0.25F, false));
		...
		cube_r15.cubeList.add(new ModelBox(cube_r15, 40, 19, -8.4497F, -3.25F, -4.25F, 3, 1, 1, 0.25F, false));
		...
		cube_r16.cubeList.add(new ModelBox(cube_r16, 24, 19, -3.1088F, -3.25F, -2.9164F, 3, 1, 1, 0.25F, false));

		cube_r17 = new ModelRenderer(this);
		cube_r17.setRotationPoint(-4.75F, 0.0F, -2.75F);
		whLayer2.addChild(cube_r17);
		setRotationAngle(cube_r17, 0.0F, -1.5708F, 0.0F);
		cube_r17.cubeList.add(new ModelBox(cube_r17, 16, 19, 0.9749F, -3.25F, -1.7751F, 3, 2, 1, 0.25F, false));
		...
		cube_r18.cubeList.add(new ModelBox(cube_r18, 8, 19, -5.0F, -3.25F, -4.25F, 3, 2, 1, 0.25F, false));
		...
		whLayer3.cubeList.add(new ModelBox(whLayer3, 36, 15, -1.5F, -5.0F, 2.2426F, 3, 2, 1, 0.0F, false));
		...
		cube_r19.cubeList.add(new ModelBox(cube_r19, 60, 15, -4.5F, -5.0F, -1.5F, 3, 2, 2, 0.0F, false));
		...
		cube_r20.cubeList.add(new ModelBox(cube_r20, 52, 15, 0.5F, -5.0F, -1.5F, 3, 2, 1, 0.0F, false));
		...
		cube_r21.cubeList.add(new ModelBox(cube_r21, 44, 15, -5.5F, -5.0F, -1.5F, 3, 2, 1, 0.0F, false));
		...
		cube_r22.cubeList.add(new ModelBox(cube_r22, 28, 15, 0.5F, -5.0F, -1.5F, 3, 2, 1, 0.0F, false));
		...
		cube_r23.cubeList.add(new ModelBox(cube_r23, 20, 15, -5.5F, -5.0F, -1.5F, 3, 2, 1, 0.0F, false));
		...
		cube_r24.cubeList.add(new ModelBox(cube_r24, 10, 15, 0.5F, -5.0F, -1.5F, 3, 2, 2, 0.0F, false));
		...
		whLayer4.cubeList.add(new ModelBox(whLayer4, 0, 11, -1.0F, -6.0F, -3.25F, 2, 2, 2, 0.25F, false));
		whLayer4.cubeList.add(new ModelBox(whLayer4, 28, 11, -1.0F, -6.0F, 1.2855F, 2, 1, 1, 0.25F, false));

		cube_r25 = new ModelRenderer(this);
		cube_r25.setRotationPoint(-0.341F, 0.0F, -0.1412F);
		whLayer4.addChild(cube_r25);
		setRotationAngle(cube_r25, 0.0F, -0.7854F, 0.0F);
		cube_r25.cubeList.add(new ModelBox(cube_r25, 46, 11, -1.0F, -6.0F, -3.25F, 2, 2, 2, 0.25F, false));
		...
		cube_r26.cubeList.add(new ModelBox(cube_r26, 40, 11, 2.0F, -6.0F, -1.25F, 2, 1, 1, 0.25F, false));
		...
		cube_r27.cubeList.add(new ModelBox(cube_r27, 34, 11, -1.0F, -6.0F, -3.25F, 2, 1, 1, 0.25F, false));
		...
		cube_r28.cubeList.add(new ModelBox(cube_r28, 22, 11, -1.0F, -6.0F, -3.25F, 2, 1, 1, 0.25F, false));
		...
		cube_r29.cubeList.add(new ModelBox(cube_r29, 16, 11, -4.0F, -6.0F, -1.25F, 2, 1, 1, 0.25F, false));

		cube_r30 = new ModelRenderer(this);
		cube_r30.setRotationPoint(0.341F, 0.0F, -0.1412F);
		whLayer4.addChild(cube_r30);
		setRotationAngle(cube_r30, 0.0F, 0.7854F, 0.0F);
		cube_r30.cubeList.add(new ModelBox(cube_r30, 8, 11, -1.0F, -6.0F, -3.25F, 2, 2, 2, 0.25F, false));
		...
		whLayer5.cubeList.add(new ModelBox(whLayer5, 0, 7, -1.0F, -7.5F, -3.5F, 2, 2, 2, 0.0F, false));
		whLayer5.cubeList.add(new ModelBox(whLayer5, 28, 7, -1.0F, -7.5F, 0.3284F, 2, 2, 1, 0.0F, false));
		...
		cube_r31.cubeList.add(new ModelBox(cube_r31, 46, 7, -1.0F, -7.5F, -3.0F, 2, 2, 2, 0.0F, false));
		...
		cube_r32.cubeList.add(new ModelBox(cube_r32, 40, 7, -1.0F, -7.5F, -1.0F, 2, 2, 1, 0.0F, false));
		...
		cube_r33.cubeList.add(new ModelBox(cube_r33, 34, 7, -1.0F, -7.5F, -3.0F, 2, 2, 1, 0.0F, false));
		...
		cube_r34.cubeList.add(new ModelBox(cube_r34, 22, 7, -1.0F, -7.5F, -3.0F, 2, 2, 1, 0.0F, false));
		...
		cube_r35.cubeList.add(new ModelBox(cube_r35, 16, 7, -2.0F, -7.5F, -1.0F, 2, 2, 1, 0.0F, false));
		...
		cube_r36.cubeList.add(new ModelBox(cube_r36, 8, 7, -1.0F, -7.5F, -3.0F, 2, 2, 2, 0.0F, false));
		...
		whLayer6.cubeList.add(new ModelBox(whLayer6, 0, 5, -0.5F, -8.35F, -2.75F, 1, 1, 1, 0.25F, false));
		whLayer6.cubeList.add(new ModelBox(whLayer6, 16, 5, -0.5F, -8.35F, -0.6287F, 1, 1, 1, 0.25F, false));
		...
		cube_r37.cubeList.add(new ModelBox(cube_r37, 28, 5, -0.5F, -1.35F, -0.25F, 1, 1, 1, 0.25F, false));
		...
		cube_r38.cubeList.add(new ModelBox(cube_r38, 24, 5, -0.5F, -1.35F, -0.25F, 1, 1, 1, 0.25F, false));
		...
		cube_r39.cubeList.add(new ModelBox(cube_r39, 20, 5, -0.5F, -1.35F, -0.25F, 1, 1, 1, 0.25F, false));
		...
		cube_r40.cubeList.add(new ModelBox(cube_r40, 12, 5, -0.5F, -1.35F, -0.25F, 1, 1, 1, 0.25F, false));
		...
		cube_r41.cubeList.add(new ModelBox(cube_r41, 8, 5, -0.5F, -1.35F, -0.25F, 1, 1, 1, 0.25F, false));
		...
		cube_r42.cubeList.add(new ModelBox(cube_r42, 4, 5, -0.5F, -1.35F, -0.25F, 1, 1, 1, 0.25F, false));
		...
		whLayer7.cubeList.add(new ModelBox(whLayer7, 0, 2, -0.5F, -9.5F, -2.0F, 1, 2, 1, 0.0F, false));
		whLayer7.cubeList.add(new ModelBox(whLayer7, 16, 2, -0.5F, -9.5F, -0.5858F, 1, 1, 1, 0.0F, false));
		...
		cube_r43.cubeList.add(new ModelBox(cube_r43, 28, 2, 4.5F, -1.5F, 2.0F, 1, 2, 1, 0.0F, false));
		...
		cube_r44.cubeList.add(new ModelBox(cube_r44, 24, 2, -1.5F, -1.5F, 0.0F, 1, 2, 1, 0.0F, false));
		...
		cube_r45.cubeList.add(new ModelBox(cube_r45, 20, 2, -1.5F, -1.5F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		cube_r46.cubeList.add(new ModelBox(cube_r46, 12, 2, -1.5F, -1.5F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		cube_r47.cubeList.add(new ModelBox(cube_r47, 8, 2, -1.5F, -1.5F, 0.0F, 1, 2, 1, 0.0F, false));
		...
		cube_r48.cubeList.add(new ModelBox(cube_r48, 4, 2, -1.5F, -1.5F, 0.0F, 1, 2, 1, 0.0F, false));
		...
		whLayer8.cubeList.add(new ModelBox(whLayer8, 0, 0, 0.0F, -9.1808F, -1.8236F, 0, 1, 1, 0.35F, false));
		...
		cube_r49.cubeList.add(new ModelBox(cube_r49, 0, 0, 0.4056F, 0.8192F, -0.6556F, 1, 1, 0, 0.35F, false));
		...
		cube_r50.cubeList.add(new ModelBox(cube_r50, 0, 0, 0.0F, 0.8192F, -0.8236F, 0, 1, 1, 0.35F, false));
		...
		cube_r51.cubeList.add(new ModelBox(cube_r51, 0, 0, -0.4056F, 0.8192F, -0.6556F, 1, 1, 0, 0.35F, false));
