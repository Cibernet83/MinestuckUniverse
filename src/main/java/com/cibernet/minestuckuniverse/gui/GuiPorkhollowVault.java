...
import com.cibernet.minestuckuniverse.network.PorkhollowVaultPacket;
...
public class GuiPorkhollowVault extends GuiScreen
{
	...
	public TileEntityPorkhollowVault vault;
	public Minecraft mc;
	...
	public GuiPorkhollowVault(EntityPlayer player, TileEntityPorkhollowVault te)
	{
		vault = te;
		this.player = player;
	...
	protected void actionPerformed(GuiButton button) throws IOException
	{
		...
		{
			MSUChannelHandler.sendToServer(MSUPacket.makePacket(MSUPacket.Type.VAULT, new Object[] {PorkhollowVaultPacket.EnumType.AUTO, vault}));
		}
		
		if(button == withdrawButton)
		{
			MSUChannelHandler.sendToServer(MSUPacket.makePacket(MSUPacket.Type.VAULT, new Object[] {PorkhollowVaultPacket.EnumType.TAKE, vault}));
